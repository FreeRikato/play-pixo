      ...
      for (let i = 0; i < stackPositions.length; i++) {
        ...
        if (
          ...
          ballPosition.value = withSpring({
            x: (stackX1 + stackX2) / 2 - BALL_RADIUS,
            y: stackY1 + numberOfBallStack1 * BALL_RADIUS,
          });
          break;
        } else if (
          i == 1 &&
          ...
          ballPosition.value = withSpring({
            x: (stackX1 + stackX2) / 2 - BALL_RADIUS,
            y: 5 + stackY1 + numberOfBallStack2 * BALL_RADIUS * 2,
          });
          break;
        }
      }
...
export default BallSpringStack;
